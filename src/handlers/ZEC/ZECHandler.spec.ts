...
test("Testnet ZEC", testEndpoints, [
    () =>
        Insight.fetchUTXOs(`https://explorer.testnet.z.cash/api/`)(
            testnetAddress,
            confirmations
        ),
]);
...
test("Mainnet ZEC", testEndpoints, [
    () =>
        Insight.fetchUTXOs(`https://explorer.z.cash/api/`)(
            mainnetAddress,
            confirmations
        ),
]);
...
test("Testnet ZEC confirmations", testEndpoints, [
    () =>
        Insight.fetchConfirmations("https://explorer.testnet.z.cash/api")(
            testnetHash
        ),
]);
...
test("Testnet ZEC UTXO", testEndpoints, [
    () =>
        Insight.fetchUTXO("https://explorer.testnet.z.cash/api")(
            testnetHash,
            0
        ),
]);
