...
test.skip("Testnet BCH", testEndpoints, _apiFallbacks.fetchUTXOs(true, testnetAddress, confirmations));
test.skip("Mainnet BCH", testEndpoints, _apiFallbacks.fetchUTXOs(false, mainnetAddress, confirmations));
...
test.skip("Testnet BCH confirmations", testEndpoints, _apiFallbacks.fetchConfirmations(true, testnetHash));
test.skip("Mainnet BCH confirmations", testEndpoints, _apiFallbacks.fetchConfirmations(false, mainnetHash));
