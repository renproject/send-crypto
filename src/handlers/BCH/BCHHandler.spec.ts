...
test("Testnet BCH UTXO", testEndpoints, _apiFallbacks.fetchUTXO(true, testnetHash, 0));
test("Mainnet BCH UTXO", testEndpoints, _apiFallbacks.fetchUTXO(false, mainnetHash, 0));
